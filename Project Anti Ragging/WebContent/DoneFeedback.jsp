...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    try{
       ...
       String overallExperience=request.getParameter("radio");
       String timelyResponse=request.getParameter("radio1");
       String ourSupport=request.getParameter("radio2");
       String ourSatisfaction=request.getParameter("radio3");
       ...
       dbv.setTimelyResponse(timelyResponse);
       dbv.setOurSupport(ourSupport);
       dbv.setOverallSatisfaction(ourSatisfaction);
       dbv.setRate(rate);
