...
<%
		...
		while(myRes.next())
		{
			...
			dbv.setState(myRes.getString("State"));
			dbv.setCollegeID(Integer.parseInt(myRes.getString("CollegeID")));
			...
			dbv.setDateRecentlyUpdated(myRes.getString("DateRecentUpdate"));
     ...
     <div id="page-wrap">
		...
		%>
	  	   ...
	  	   <%out.print("<tr><td><h2> Name:</h2></td><td><h2>"+dbv.getFirstName()+" "+dbv.getLastName()+"</h2></td></tr>"+
	  			       ...
	  			       "<tr><td><h2> Location:</h2></td><td><h2>"+dbv.getCity()+","+dbv.getState()+"</h2></td></tr>"+
